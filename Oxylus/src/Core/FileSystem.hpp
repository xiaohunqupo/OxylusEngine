...
std::pair<std::string,
          std::string>
split_path(std::string_view full_path);
...
std::string append_paths(std::string_view path,
...
/// @brief copy file
void copy_file(std::string_view from,
               std::string_view to);
...
template <typename T>
bool write_file(const std::string_view file_path,
                const T& data,
...
bool write_file_binary(std::string_view file_path,
                       const std::vector<u8>& data);

bool binary_to_header(std::string_view file_path,
